        ...
        <nav class="bg-[#495E57] border-gray-200">
            <div class="xl:max-screen-3xl md:max-w-screen-2xl  flex flex-wrap items-center justify-between mx-5 p-4">
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul
                        class="flex flex-col list-none p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
                        <li>
