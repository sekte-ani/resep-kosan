...
<div class="md:mx-10 md:mt-10 md:grid grid-cols-3  ">
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow relative overflow-hidden">
        <a href="#" class="relative">
            <img src="{{ asset('images/jelly.jpg') }}" alt="Logo Perusahaan" class="w-full h-auto">
            <div class="absolute inset-0 bg-black opacity-20"></div>
        </a>
        <div class="p-5 absolute bottom-0 left-0 w-full bg-gradient-to-b from-transparent to-yellow-200">
            <a href="#">
                <h5 class="mb-2  block text-3xl font-bold tracking-tight text-white ">Es Jelly Cappucino</h5>
            </a>
    ...
    </div><div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow relative overflow-hidden">
        <a href="#" class="relative">
            <img src="{{ asset('images/jelly.jpg') }}" alt="Logo Perusahaan" class="w-full h-auto">
            <div class="absolute inset-0 bg-black opacity-20"></div>
        </a>
